...
import com.example.medicomgmester.handler.NotificationHandler
import com.example.medicomgmester.views.SettingsAdapter
...
class SettingsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        this.settingsContext = requireContext()
