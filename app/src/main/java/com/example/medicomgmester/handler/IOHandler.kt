...
import com.example.medicomgmester.BuildConfig
import com.example.medicomgmester.R
import com.example.medicomgmester.models.*
...
object IOHandler {
    ...
    fun getStringFromKey(key: String): String? {
        return if (IOHandler::sharedPrefSettings.isInitialized) {
    ...
    fun getHighestIndex(): Int {
        var highest = 0
        if (IOHandler::sharedPrefEventData.isInitialized) {
